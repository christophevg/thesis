...
bericht toegevoegd, nl. de drie bijkomende netwerk adressen van de betrokken:
...
de eindknoop netwerk adres \ttt{ae f5} en de router adres \ttt{fa 7d}. We zien
...
\vspace{-5mm}
\captionof{listing}{Initialisatie van het maasnetwerk. (demo/lib/network.c)
