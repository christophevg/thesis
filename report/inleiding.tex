...
(\emph{System-on-Chip}) (SoC) genoemd. Figuur \ref{fig:motes} toont
...
\begin{description}
  ...
  van onderdelen van het netwerk garanderen, om er zeker van te zijn dit
...
internet-gerelateerde diensten (\emph{triple A}) \citep{rfc:2904}. De
...
(\emph{policy}), waarin de regels waaraan alle spelers binnen het te
