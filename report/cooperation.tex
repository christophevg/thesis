...
\TODO \cite{li2008group} -> grouping

\TODO \cite{huang2003cooperative} -> clustering and state machine (TODO: feature for FOO-lang)

\TODO \cite{marchang2008collaborative} -> different cooperative algoritms

\TODO \cite{ioannis2007towards}
