...
vervolgens gezamenlijk, op een gedistribueerde manier, trachten tot een
...
die in een ruimere situatie misschien een verkeerd beeld zouden kunnen
...
een algoritme voor op basis van verschillen, een zgn. delta-algoritme.
