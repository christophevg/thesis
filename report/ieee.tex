...
radio are prime candidates. A prototype codegenerator was realized to show
...
of a codegenerator framework to complement the language. Section
...
We have built a prototype codegenerator for FOO-lang using Python and ANTLR
...
The codegenerator aims to be language and platform independent. Both language
...
event loop. The codegenerator was provided with FOO-lang descriptions of the
