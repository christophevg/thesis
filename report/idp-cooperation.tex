...
Twee condities worden voorgesteld: de ``Intrusion Detection Condition'' (IDC)
en de ``Neighbourhood Conditions'' (NC). Indien aan minstens \'e\'en van deze
...
want $\tilde{AN}(q,r) = \{s\} \not= \tilde{AN}(r,q) = \{\}$. Er zijn nu echter
...
gemaakt van sleutels door het toepassen van bv. SHA1-hashing \citep{rfc:3174}
...
volledige initialisatiefase wordt verondersteld te gebeuren zonder mogelijkheid
tot inbraken.
...
door het toepassen van een \'e\'enrichtings-hashfunctie op de boodschap.
Typisch wordt er aan de boodschap een unieke, wederzijds gekende identificatie
...
zijn, wat overeenkomt met een gelijke samenstelling van gealarmeerde buren,
...
gealarmeerde knopen. Deze zullen op hun beurt nagaan of de knopen die verdacht
worden, buren zijn en dan aangeven dat zij hen \emph{niet} verdenken. Aan de
hand van deze informatie kunnen de eerder gealarmeerde knopen hun beslissing
verder staven.
