...
daarom een eerste component, \ttt{COMM}, die zich toespitst op communicatie en
waarlangs alle gegevens passeren die verstuurd en/of ontvangen worden.
Daarnaast zijn er nog drie bijkomende componenten: \ttt{M-Core}, de centrale
controlemodule, \ttt{Sense}, de sensormodule en de \ttt{DDMs}, de detectie- en
...
De drie modules vormen als het ware een interface voor de \ttt{DDMs}. De manier
