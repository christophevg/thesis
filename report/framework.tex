...
communicatiekanalen. Ze defini\"eren daarom een eerste component, \ttt{COMM},
...
componenten: \ttt{M-Core}, de centrale controlemodule, \ttt{Sense}, de
sensormodule en de \ttt{DDMs}, de detectie- en verdedigingsmodules. Deze
...
De drie modules vormen als het ware een API voor de \ttt{DDMs} en de manier
